...
export function Hero({ configuracion }: HeroProps) {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <Image
        src={configuracion.heroImagenUrl}
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center z-10 max-w-7xl mx-auto px-4">
        <h1 className="text-5xl md:text-7xl lg:text-[7rem] font-black uppercase tracking-[-0.02em] text-white mb-4 whitespace-pre-line">
